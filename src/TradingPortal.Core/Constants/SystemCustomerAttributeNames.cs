...
namespace TradingPortal.Core.Constants
{
    public static partial class SystemCustomerAttributeNames
    {
        ...
        //Amark specific
        public static string AmarkTradingPartnerNumber { get { return "AmarkTradingPartnerNumber"; } }
        public static string AmarkTPAPIKey { get { return "AmarkTPAPIKey"; } }
