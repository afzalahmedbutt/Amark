...
namespace TradingPortal.Infrastructure.Services.Interfaces
{
    public interface ISettingsService
    {
        ...
        T GetSettingsByKeyAndStoreId<T>(string key, int storeId, T defaultValue = default(T));

        Task<T> GetSettingsByKeyAndStoreIdAsync<T>(string key, int storeId, T defaultValue = default(T));
        /// <summary>
        /// Clear cache
        /// </summary>
        void ClearCache();
