...
export class Utilities {
  ...
  public static printDateOnly(date: any ) {
  ...
  public static printTimeOnly(date: any) {
  ...
  //public static printFriendlyDate(date: any, separator = "-") {
  ...
  public static printDuration(start: any, end: any) {
