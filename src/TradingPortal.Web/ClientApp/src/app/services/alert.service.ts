...
export class AlertService {
  ...
  private showCloseButton = new Subject<boolean>();
  showCloseButton$ = this.showCloseButton.asObservable();
  ...
  startLoadingMessage(message = "Loading...", caption = "") {
    ...
    this.showHideCloseButton(false);
  ...
  showHideCloseButton(show : boolean) {
    this.showCloseButton.next(show);
  }
