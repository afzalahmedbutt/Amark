...
namespace TradingPortal.Business
{
    ...
    {
        private readonly ICheckoutAttributeManager _checkoutAttributeManager;

        public CheckoutAttributeParser(ICheckoutAttributeManager checkoutAttributeManager)
        {
            this._checkoutAttributeManager = checkoutAttributeManager;
        }
        ...
        public virtual IList<CheckoutAttribute> ParseCheckoutAttributes(string attributes)
        {
            ...
            {
                var ca = _checkoutAttributeManager.GetCheckoutAttributeById(id);
                if (ca != null)
                {
                    caCollection.Add(ca);
                }
            ...
            foreach (var ca in caCollection)
            {
                ...
                foreach (string caValueStr in caValuesStr)
                {
                    if (!String.IsNullOrEmpty(caValueStr))
                    {
                        ...
                        {
                            var caValue = _checkoutAttributeManager.GetCheckoutAttributeValueById(caValueId);
                            if (caValue != null)
        ...
        public static bool RequiresShipping(IList<ShoppingCartItem> shoppingCart)
        {
        ...
        public static bool ShouldHaveValues(CheckoutAttribute checkoutAttribute)
        {
